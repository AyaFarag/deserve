<div class="container mb-5 mt-5">
        <div class="pricing card-deck flex-column flex-md-row mb-3">
            ...
            <div class="card card-pricing text-center px-3 mb-4">
                ...
                <div class="card-body pt-0">
                    <ul class="list-unstyled mb-4">
                        ...
                        <li><a href="/plan"> learn more </ac> </a></li>
                    </ul>
            ...
            <div class="card card-pricing popular shadow text-center px-3 mb-4">
                ...
                <div class="bg-transparent card-header pt-4 border-0">
                    <h1 class="h1 font-weight-normal text-primary text-center mb-0" data-pricing-value="30">$<span class="price">3000</span></h1>
                </div>
                <div class="card-body pt-0">
                    <ul class="list-unstyled mb-4">
                        <li>Up to 5 users</li>
            ...
            <div class="card card-pricing text-center px-3 mb-4">
                ...
                <div class="bg-transparent card-header pt-4 border-0">
                    <h1 class="h1 font-weight-normal text-primary text-center mb-0" data-pricing-value="45">$<span class="price">5000</span></h1>
                </div>
                <div class="card-body pt-0">
                    <ul class="list-unstyled mb-4">
                        <li>Up to 5 users</li>
            ...
            <div class="card card-pricing text-center px-3 mb-4">
                ...
                <div class="bg-transparent card-header pt-4 border-0">
                    <h1 class="h1 font-weight-normal text-primary text-center mb-0" data-pricing-value="60">$<span class="price">7000</span></h1>
                </div>
                <div class="card-body pt-0">
                    <ul class="list-unstyled mb-4">
                        <li>Up to 5 users</li>
